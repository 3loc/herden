...
_Last updated: September 13, 2026._
...
delete. For a privacy or deletion request, email
[ted@3loc.ltd](mailto:ted@3loc.ltd?subject=Herden%20privacy). Do not include
credentials, tokens, Host details, or other sensitive information in the first
message.

## Custom relay URL

The notification plugin and Herden accept a custom push relay base URL, so you can run
your own relay instead of the 3loc-hosted one. The maintained source is not
currently published while Herden is in private beta.
...
[ted@3loc.ltd](mailto:ted@3loc.ltd?subject=Herden%20privacy) and do not include
sensitive information. Report suspected vulnerabilities to
[ted@3loc.ltd](mailto:ted@3loc.ltd?subject=Herden%20security) with the affected
version and a minimal reproduction, but never include private keys, passwords,
tokens, Host addresses, or user content.
