...
// herden 0.7.5 (protocol 17) server responses.
@Suite struct HerdrWireTests {
    ...
    @Test func agentMappingDegradesMissingWireFields() throws {
        // herden's API has no stability guarantee: nullable wire fields must
    ...
    @Test func agentMappingResolvesNameWithDisplayAgentPrecedence() throws {
        // `herden agent start testbash` shape: unrecognized program, but the
    ...
    @Test func errorEnvelopeWithBlankIDStillThrowsAPIError() throws {
        // Live capture: herden 0.8.0 answers a request it could not parse with
    ...
    @Test func nonJSONResponseIsMalformed() throws {
        let line = "bash: line 1: herden: command not found"
