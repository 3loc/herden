...
struct WorktreeDetailStoreTests {
    @Test func snapshotMetadataAndScopedListPresentTheBranch() async {
        ...
        #expect(store.checkout.repoName == "Herden")
        #expect(store.checkout.checkoutPath == "/work/Herden-wt")
    ...
    private func makeStore(
        ...
        let checkout = RepositoryCheckout(
            repoKey: "/work/Herden/.git",
            repoName: "Herden",
            repoRoot: "/work/Herden",
            checkoutPath: "/work/Herden-wt",
    ...
    private static func list(
        ...
        WorktreeListResponse(
            source: WorktreeSourceInfo(
                ...
                repoName: "Herden",
                repoRoot: "/work/Herden",
                sourceCheckoutPath: "/work/Herden"),
            worktrees: [
                WorktreeInfo(
                    isBare: false,
                    isDetached: detached,
