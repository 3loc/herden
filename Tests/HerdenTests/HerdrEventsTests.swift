...
// kind list mirrors herden 0.7.4's schema (26 subscribable kinds); event-line
...
@Suite struct HerdrEventsTests {
    ...
    @Test func dottedWireNamesAreAcceptedToo() {
        // herden's schema spells the typed event kinds dotted while the live
    ...
    @Test func unknownWireNamesPassThroughUnchanged() {
        // herden's API has no stability guarantee: a kind we do not know keeps
