...
///
/// `scripts/run-ci-ios-tests.sh` exports `HERDEN_SSH_E2E_REQUIRED=1` into the
...
enum RealSSHFixture {
    ...
    /// has a fixture configured. The gate keeps `HERDEN_SSH_E2E_REQUIRED` set
    ...
    private static var requirement: String? {
        ProcessInfo.processInfo.environment["HERDEN_SSH_E2E_REQUIRED"]
    }
