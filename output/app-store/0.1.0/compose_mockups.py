#!/usr/bin/env python3
"""Compose deterministic App Store screenshots from exact Herden captures."""
...
MOCKUPS = (
    Mockup(
        output_name="01-type-directly-stay-in-flow.png",
    ...
    Mockup(
        output_name="03-your-shell-within-reach.png",
