...
grep -Fq "Herden 0.9.1 is ready" "$fixture/install.out"
...
test "$("$fixture/install/herden" --version)" = 'herden 0.9.1'
...
grep -Fq 'is already 0.9.1' "$fixture/optional.out"
grep -Fqx 'plugin install 3loc/herden/plugin --ref host-v0.9.1 --yes' "$fixture/plugin.log"
...
grep -Fq "expected 'herden 0.9.1'" "$fixture/wrong-version.err"
