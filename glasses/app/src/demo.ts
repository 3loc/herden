...
export const demoOutput = [
  ...
  'Opened the landing page project.',
  'Checked the layout on a small phone.',
  'Fixed the navigation breakpoint.',
  'Aligned the hero copy and controls.',
  'Retested the tablet layout.',
  'Checked desktop widths too.',
