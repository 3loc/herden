...
| Sharing from another iOS app | Reuses the inherited preparation, SSH and upload foundations. | Herden's Share Extension target, Agent selection, transient transfer recovery and direct path insertion. |
