...
final class ComposerStagingStore {
            ...
            case .background:
                state = .backgroundInterrupted(
                    Failure(
                        medium: medium,
                        message:
                            "\(medium.displayName) upload paused when Herden moved to the background.",
    ...
    private static func failure(for error: any Error, medium: Medium) -> Failure {
        ...
        case ImagePreparationError.localStorageFailed:
            Failure(
                medium: medium,
                message: "Herden couldn't prepare the image in protected local storage.",
                isRetryable: false)
        ...
        case FilePreparationError.localStorageFailed:
            Failure(
                medium: medium,
                message: "Herden couldn't prepare the file in protected local storage.",
                isRetryable: false)
        default:
            Failure(
                medium: medium,
