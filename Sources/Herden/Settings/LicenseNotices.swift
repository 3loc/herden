...
struct LicenseInventory: Equatable, Sendable {
    ...
    struct DependencyCoverage: Equatable, Sendable {
        ...
        /// `Packages/HerdenSSH/Package.swift` `.binaryTarget` `name` → component ids.
        let herdenSSHBinaryTargets: [String: [String]]
        /// `project.yml` `packages:` entry name linked from the Herden app
...
enum LicenseNoticeCatalog {
    ...
    private static func decodeCoverage(
        ...
        return LicenseInventory.DependencyCoverage(
            ...
            herdenSSHBinaryTargets: try normalize(
                dto.herdenSSHBinaryTargets, label: "herdenSSHBinaryTargets"),
