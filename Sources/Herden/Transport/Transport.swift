...
protocol Transport: Sendable {
    ...
    /// snapshot, and consume events throughout that request. Repeat this
    /// sequence after reconnect or subscription replacement. Herden 0.9
    /// lifecycle subscriptions are live-only; the event replay observed on
    /// 0.7.5 was historical behavior, not a recovery guarantee. Snapshots
    /// remain the authoritative convergence mechanism.
