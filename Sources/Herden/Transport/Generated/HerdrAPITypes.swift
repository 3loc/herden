...
// Source: `herden api schema --json` (protocol 22, schema_version 1).
//
...
/// herden schema `$defs/AgentPromptParams`.
...
/// herden schema `$defs/AgentPromptWaitOptions`.
...
/// herden schema `$defs/AgentReadParams`.
...
/// herden schema `$defs/AgentRenameParams`.
...
/// herden schema `$defs/AgentSendKeysParams`.
...
/// herden schema `$defs/AgentSessionInfo`.
...
/// herden schema `$defs/AgentSessionRefKind`.
///
...
/// herden schema `$defs/AgentStartParams`.
...
/// herden schema `$defs/AgentStatus`.
///
/// Closed set in the source schema, but herden's API has no stability
/// guarantee — unknown raw values decode intact instead of failing.
...
/// herden schema `$defs/AgentTarget`.
...
/// herden schema `$defs/PaneLayoutPane`.
...
/// herden schema `$defs/PaneLayoutRect`.
...
/// herden schema `$defs/PaneLayoutSnapshot`.
...
/// herden schema `$defs/PaneLayoutSplit`.
...
/// herden schema `$defs/PaneProcessInfo`.
...
/// herden schema `$defs/PaneProcessInfoParams`.
...
/// herden schema `$defs/PaneProcessInfoProcess`.
...
/// herden schema `$defs/PaneReadParams`.
...
/// herden schema `$defs/PaneReadResult`.
...
/// herden schema `$defs/PaneScrollInfo`.
...
/// herden schema `$defs/PaneSendInputParams`.
...
/// herden schema `$defs/ServerCapabilities`.
...
/// herden schema `$defs/SessionSnapshot`.
...
/// herden schema `$defs/SplitDirection`.
///
/// Closed set in the source schema, but herden's API has no stability
/// guarantee — unknown raw values decode intact instead of failing.
...
/// herden schema `$defs/TabCreateParams`.
...
/// herden schema `$defs/WorkspaceCloseParams`.
...
/// herden schema `$defs/WorkspaceCreateParams`.
...
/// herden schema `$defs/WorkspaceInfo`.
...
/// herden schema `$defs/WorkspaceRenameParams`.
...
/// herden schema `$defs/WorkspaceWorktreeInfo`.
...
/// herden schema `$defs/WorktreeCreateParams`.
...
/// herden schema `$defs/WorktreeInfo`.
...
/// herden schema `$defs/WorktreeListParams`.
...
/// herden schema `$defs/WorktreeRemoveParams`.
...
/// herden schema `$defs/WorktreeSourceInfo`.
