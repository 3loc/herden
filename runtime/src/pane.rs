...
impl PaneRuntime {
    ...
    pub fn from_handoff_fd(
        ...
        // The imported child has already had an opportunity to query and cache
        // this PTY's colours. A live Host upgrade must not make the next viewer
        // authoritative and reopen cross-client palette leakage.
        pane_terminal.freeze_application_terminal_theme();
...
mod tests {
    ...
    #[tokio::test]
    async fn subscribed_idle_child_keeps_observed_color_scheme() {
