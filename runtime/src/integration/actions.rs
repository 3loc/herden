...
pub(crate) fn uninstall_experimental_letta() -> io::Result<Vec<String>> {
    let result = uninstall_letta().map(|result| {
        ...
        if result.updated_settings {
            messages.push(format!(
                "removed Herden Letta hook entry from {}",
                result.settings_path.display()
            ));
        } else {
            messages.push(format!(
                "no Herden Letta hook entry found in {}",
                result.settings_path.display()
            ));
        }
        messages
    ...
    let mut messages = match target {
        ...
        crate::api::schema::IntegrationTarget::Droid => {
            ...
            if installed.updated_legacy_hooks {
                messages.push(format!(
                    "removed legacy herden droid hook entries from {}",
...
pub(crate) fn uninstall_target(
    ...
    let messages = match target {
        ...
        crate::api::schema::IntegrationTarget::Claude => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed herden claude hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden claude hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Codex => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed herden codex hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden codex hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages.push(format!(
        ...
        crate::api::schema::IntegrationTarget::Copilot => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed herden copilot hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden copilot hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Devin => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed herden devin hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden devin hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Kimi => {
            ...
            if result.updated_config {
                messages.push(format!(
                    "removed herden kimi hook entries from {}",
                    result.config_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden kimi hook entries found in {}",
                    result.config_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Droid => {
            ...
            if result.updated_hooks {
                ...
                messages.push(format!(
                    "no legacy herden droid hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            if result.updated_settings {
                messages.push(format!(
                    "removed herden droid hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden droid hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Opencode => {
            ...
            if result.updated_tui_config {
                messages.push(format!(
                    "removed herden opencode plugin entry from {}",
        ...
        crate::api::schema::IntegrationTarget::Qodercli => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed herden qodercli hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden qodercli hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Qwen => {
            ...
            if result.updated_settings {
                messages.push(format!(
                    "removed herden qwen hook entries from {}",
                    result.settings_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden qwen hook entries found in {}",
                    result.settings_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Cursor => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed herden cursor hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden cursor hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::Mastracode => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed herden mastracode hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden mastracode hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
        ...
        crate::api::schema::IntegrationTarget::AntigravityCli => {
            ...
            if result.updated_hooks {
                messages.push(format!(
                    "removed herden antigravity-cli hook entries from {}",
                    result.hooks_path.display()
                ));
            } else {
                messages.push(format!(
                    "no herden antigravity-cli hook entries found in {}",
                    result.hooks_path.display()
                ));
            }
            messages
