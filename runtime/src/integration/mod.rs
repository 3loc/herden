...
const OPENCODE_V2_TUI_PLUGIN_DIR: &str = "herden-opencode";
const OPENCODE_V2_TUI_PLUGIN_SPEC: &str = "./herden-opencode";
...
const LETTA_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/letta/herden-agent-session.ps1")
} else {
    include_str!("assets/letta/herden-agent-session.sh")
};
