...
# Session-only: this hook reports the Antigravity conversation so Herden can
# resume the pane. Lifecycle state comes from Herden's screen detection.
...
try {
    ...
    & $herden @sessionArgs 2>$null | Out-Null
} catch {
}
