...
pub struct KeysConfig {
    ...
    /// Detach the current client from its Herden server. Default: "prefix+q".
    ...
    /// Local-client shortcut that sends a clipboard image to a remote Herden session. Default: "ctrl+v".
...
pub struct RemoteConfig {
    /// Add keepalive fallbacks and private connection reuse for `herden --remote`.
...
pub struct ExperimentalConfig {
    /// Allow launching herden inside an existing herden pane. Default: false.
