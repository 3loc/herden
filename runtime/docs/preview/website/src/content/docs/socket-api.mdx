...
a package with a `herden-plugin.toml` manifest. The manifest declares startup
...
The path can be a plugin directory containing `herden-plugin.toml` or a direct
