...
<img src="docs/images/logo.png" width="100" alt="Herden Live Tether logo" />

# Herden

**The runtime your coding agents live on, with a native iPhone console.**

[Website](https://herden.app) · [Download for iPhone](https://testflight.apple.com/join/nSsEZBvv) · [Quick start](#quick-start) · [Host guide](docs/guides/install-host.md) · [Build from source](docs/guides/build-ios.md)
...
```sh
curl -fsSL https://herden.app/install.sh | sh
...
- **Share from another iOS app:** In Files, Photos or another app supporting
  ...
  Return. Open the Agent to add context. Transfer state is removed after the
  file path has been delivered.
...
- **Inherited uploads, extended delivery:** Heeler already provided image/file
  ...
  insertion and crash-safe transient transfer recovery.
